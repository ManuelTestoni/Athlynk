...
// MARK: - Mascot (real centaur image when present, animated stylised fallback)
...
struct ChironMascot: View {
    ...
    /// Real generated artwork if it has been added to the asset catalog.
