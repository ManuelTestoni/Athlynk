...
urlpatterns = [
    ...
    path('api/nutrizione/integratori/modelli/salva/', views_nutrition.api_supplement_save_template, name='nutrizione_supplement_save_template'),
    path('api/nutrizione/integratori/modelli/<int:item_id>/elimina/', views_nutrition.api_supplement_template_delete, name='nutrizione_supplement_template_delete'),
    ...
    path('api/v1/settings', mobile_api.settings, name='api_v1_settings'),
    ...
    path('api/v1/coach/supplements/templates/save', coach_api.coach_supplement_template_save, name='api_v1_coach_supplement_template_save'),
    path('api/v1/coach/supplements/templates/<int:item_id>/delete', coach_api.coach_supplement_template_delete, name='api_v1_coach_supplement_template_delete'),
